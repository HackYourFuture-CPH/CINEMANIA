...
exports.seed = async function (knex) {
  ...
  await knex('movie_crew').insert([
    ...
    { movie_id: 71, crew_member_id: 69, role: 'Actor' },
    { movie_id: 71, crew_member_id: 70, role: 'Actor' },
    { movie_id: 71, crew_member_id: 71, role: 'Actor' },
    { movie_id: 71, crew_member_id: 72, role: 'Actor' },
    { movie_id: 71, crew_member_id: 73, role: 'Actor' },
    { movie_id: 71, crew_member_id: 74, role: 'Actor' },
    { movie_id: 71, crew_member_id: 75, role: 'Actor' },
    { movie_id: 71, crew_member_id: 76, role: 'Actor' },
    { movie_id: 71, crew_member_id: 77, role: 'Actor' },
    { movie_id: 71, crew_member_id: 78, role: 'Actor' },
    { movie_id: 71, crew_member_id: 79, role: 'Director' },
    { movie_id: 71, crew_member_id: 80, role: 'Writer' },
    { movie_id: 24, crew_member_id: 81, role: 'Actor' },
    { movie_id: 24, crew_member_id: 82, role: 'Actor' },
    { movie_id: 24, crew_member_id: 83, role: 'Actor' },
    { movie_id: 24, crew_member_id: 84, role: 'Actor' },
    { movie_id: 24, crew_member_id: 85, role: 'Actor' },
  ]);
};
